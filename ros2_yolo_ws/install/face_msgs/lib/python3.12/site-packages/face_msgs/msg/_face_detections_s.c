...
bool face_msgs__msg__face_detections__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("face_msgs.msg._face_detections.FaceDetections", full_classname_dest, 45) == 0);
  }
  face_msgs__msg__FaceDetections * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FaceDetections */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("face_msgs.msg._face_detections");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FaceDetections");
