  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xf3, 0x25, 0xe9, 0x0b, 0x67, 0x8c, 0x72, 0x31,
      0x43, 0xc5, 0xa9, 0xd8, 0x49, 0xce, 0x0c, 0xc7,
      0xac, 0x73, 0x04, 0x1c, 0x7b, 0x0a, 0xc6, 0xad,
      0x93, 0xb5, 0xc4, 0x14, 0x0c, 0x0c, 0x7d, 0x2a,
    }};
  return &hash;
}
...
static char face_msgs__msg__FaceDetections__TYPE_NAME[] = "face_msgs/msg/FaceDetections";
...
static char face_msgs__msg__FaceDetections__FIELD_NAME__header[] = "header";
static char face_msgs__msg__FaceDetections__FIELD_NAME__image[] = "image";
static char face_msgs__msg__FaceDetections__FIELD_NAME__detections[] = "detections";

static rosidl_runtime_c__type_description__Field face_msgs__msg__FaceDetections__FIELDS[] = {
  {
    {face_msgs__msg__FaceDetections__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {face_msgs__msg__FaceDetections__FIELD_NAME__image, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {face_msgs__msg__FaceDetections__FIELD_NAME__detections, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription face_msgs__msg__FaceDetections__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {face_msgs__msg__FaceDetections__TYPE_NAME, 28, 28},
      {face_msgs__msg__FaceDetections__FIELDS, 3, 3},
    },
    {face_msgs__msg__FaceDetections__REFERENCED_TYPE_DESCRIPTIONS, 14, 14},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[9].fields = vision_msgs__msg__Detection2DArray__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "sensor_msgs/Image image #original frame\n"
  "vision_msgs/Detection2DArray detections #the face detections ";
...
face_msgs__msg__FaceDetections__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *face_msgs__msg__FaceDetections__get_individual_type_description_source(NULL),
    ...
    sources[10] = *vision_msgs__msg__Detection2DArray__get_individual_type_description_source(NULL);
