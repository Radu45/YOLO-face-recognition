...
static const rosidl_type_hash_t face_msgs__msg__Face__EXPECTED_HASH = {1, {
    0xad, 0x86, 0x66, 0xc3, 0xbc, 0x45, 0x24, 0xeb,
    0x81, 0x5a, 0x28, 0x1c, 0xa5, 0xfd, 0x8f, 0x93,
    0x54, 0x06, 0x83, 0x9f, 0x43, 0x94, 0x29, 0xf5,
    0x91, 0x02, 0x22, 0x2c, 0x9e, 0x99, 0xc0, 0xf9,
  }};
...
static char face_msgs__msg__FaceEmbeddingArray__TYPE_NAME[] = "face_msgs/msg/FaceEmbeddingArray";
static char builtin_interfaces__msg__Time__TYPE_NAME[] = "builtin_interfaces/msg/Time";
static char face_msgs__msg__Face__TYPE_NAME[] = "face_msgs/msg/Face";
...
static rosidl_runtime_c__type_description__Field face_msgs__msg__FaceEmbeddingArray__FIELDS[] = {
  {
    {face_msgs__msg__FaceEmbeddingArray__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {face_msgs__msg__FaceEmbeddingArray__FIELD_NAME__faces, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {face_msgs__msg__Face__TYPE_NAME, 18, 18},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription face_msgs__msg__FaceEmbeddingArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  if (!constructed) {
    ...
    assert(0 == memcmp(&face_msgs__msg__Face__EXPECTED_HASH, face_msgs__msg__Face__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[1].fields = face_msgs__msg__Face__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  if (!constructed) {
    ...
    sources[2] = *face_msgs__msg__Face__get_individual_type_description_source(NULL);
