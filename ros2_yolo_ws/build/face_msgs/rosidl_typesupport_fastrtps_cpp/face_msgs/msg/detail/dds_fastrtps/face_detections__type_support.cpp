...
#include "face_msgs/msg/detail/face_detections__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const face_msgs::msg::FaceDetections & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  face_msgs::msg::FaceDetections & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_face_msgs
max_serialized_size_FaceDetections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = face_msgs::msg::FaceDetections;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_face_msgs
max_serialized_size_key_FaceDetections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const face_msgs::msg::FaceDetections *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<face_msgs::msg::FaceDetections *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaceDetections__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const face_msgs::msg::FaceDetections *>(
...
static size_t _FaceDetections__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaceDetections(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FaceDetections__callbacks = {
  "face_msgs::msg",
  "FaceDetections",
...
static rosidl_message_type_support_t _FaceDetections__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaceDetections__callbacks,
...
{
  return &face_msgs::msg::typesupport_fastrtps_cpp::_FaceDetections__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, face_msgs, msg, FaceDetections)() {
  return &face_msgs::msg::typesupport_fastrtps_cpp::_FaceDetections__handle;
}
