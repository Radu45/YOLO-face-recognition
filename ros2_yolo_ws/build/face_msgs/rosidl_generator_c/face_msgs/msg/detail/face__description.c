...
static char face_msgs__msg__Face__FIELD_NAME__detection[] = "detection";
static char face_msgs__msg__Face__FIELD_NAME__embedding[] = "embedding";

static rosidl_runtime_c__type_description__Field face_msgs__msg__Face__FIELDS[] = {
  {
    {face_msgs__msg__Face__FIELD_NAME__detection, 9, 9},
    {
  ...
  {
    {face_msgs__msg__Face__FIELD_NAME__embedding, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription face_msgs__msg__Face__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {face_msgs__msg__Face__FIELDS, 2, 2},
    },
    {face_msgs__msg__Face__REFERENCED_TYPE_DESCRIPTIONS, 12, 12},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *face_msgs__msg__Face__get_individual_type_description_source(NULL),
