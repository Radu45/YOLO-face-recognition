...
static rosidl_typesupport_introspection_c__MessageMember face_msgs__msg__FaceEmbeddingArray__rosidl_typesupport_introspection_c__FaceEmbeddingArray_message_member_array[3] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(face_msgs__msg__FaceEmbeddingArray, image),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, face_msgs, msg, FaceEmbeddingArray)() {
  ...
  face_msgs__msg__FaceEmbeddingArray__rosidl_typesupport_introspection_c__FaceEmbeddingArray_message_member_array[2].members_ =
