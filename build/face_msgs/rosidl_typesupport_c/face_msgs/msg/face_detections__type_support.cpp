...
static const _FaceDetections_type_support_symbol_names_t _FaceDetections_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, face_msgs, msg, FaceDetections)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, face_msgs, msg, FaceDetections)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, face_msgs, msg, FaceDetections)() {
  return &::face_msgs::msg::rosidl_typesupport_c::FaceDetections_message_type_support_handle;
}
