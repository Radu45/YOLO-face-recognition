...
static const _Face_type_support_symbol_names_t _Face_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, face_msgs, msg, Face)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, face_msgs, msg, Face)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, face_msgs, msg, Face)() {
  return &::face_msgs::msg::rosidl_typesupport_c::Face_message_type_support_handle;
}
